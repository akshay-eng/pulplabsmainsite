...
export const platforms = [
  ...
  },
  {
    ...
    blurb:
      'The broadest tooling surface of the five: Assistants, function calling, realtime voice, and Codex for engineering work. Usually the fastest route from an idea to something a team can click on.',
  },
  {
    id: 'copilot',
    name: 'Copilot',
  ...
  },
  {
    ...
    blurb:
      'Native multimodality that handles documents, images, audio and video in one context, plus tight Workspace integration and Vertex AI for teams already on Google Cloud.',
  },
  {
    id: 'watsonx',
...
export const curriculum = {
  claude: {
    'one-day': C(
      [
        ['Where this model is actually better', 'Long-context reasoning, careful instruction-following and refusal behaviour, plus the tasks where a cheaper model is the right call.'],
  ...
  copilot: {
    'one-day': C(
      [
        ['Copilot across M365', 'What it genuinely does in Teams, Outlook, Word and Excel, plus the expectations worth resetting early.'],
